...
public class Validacion {
    ...
    public static boolean estaVacio(String cadena, String campo){
        boolean bandera;
        if (cadena.isEmpty()){
            JOptionPane.showMessageDialog(null, "El dato ingresado en " + campo + " debe estar lleno");
            bandera = false;
        }else{
            bandera = true;
        }
    ...
    public static boolean Tama(String cadena, String campo){
        boolean bandera;
        if (cadena.length() != 3){
            JOptionPane.showMessageDialog(null, "El dato ingresado en " + campo + " debe tener 3 dígitos");
            bandera = false;
        }else{
            bandera = true;
        }
